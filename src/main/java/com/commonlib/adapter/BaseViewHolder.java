...
import com.aialias.hlibraries.utils.StringUtils;
...
public class BaseViewHolder extends RecyclerView.ViewHolder {
    ...
    public BaseViewHolder setText(int viewId, String text) {
        TextView textView = getView(viewId);
        if (textView != null){
            textView.setText(StringUtils.INSTANCE.formatString(text));
        }
        return this;
    }
    ...
    public BaseViewHolder setImageUrl(int viewId, String url,int draw) {
        ImageView view = getView(viewId);
        Picasso.with(mContext).load(url)
                .placeholder(draw)
                .error(draw)
