 ...
 *
 * @author HERB
 * @date Created on 2018/2/12 20:38
 * @function: 数据本地持久化
 */
class AppSharePreferenceMgr(name:String) {
    /**
     * 保存在手机里面的文件名
     */
    private  val FILE_NAME = name

    /**
     * 保存数据的方法，我们需要拿到保存数据的具体类型，然后根据类型调用不同的保存方法
     */
    fun put(context: android.content.Context?, key: String, `object`: Any) {
